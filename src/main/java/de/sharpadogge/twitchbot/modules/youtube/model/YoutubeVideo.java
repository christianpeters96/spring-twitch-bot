...
import de.sharpadogge.twitchbot.modules.youtube.OnYoutubeDownloadListener;
...
import static de.sharpadogge.twitchbot.modules.youtube.model.Utils.*;
...
public class YoutubeVideo {
    ...
    public Long getDurationMs() {
        ...
        for (Format format : formats()) {
            if (format.duration() > 0) videoDurationMs = format.duration();
        }
